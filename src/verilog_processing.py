# source: https://github.com/you-li-nu/hls_bench/blob/main/vivado_evaluator/verilog_processing.py
...
def construct_kairos(src_a: VerilogFile, src_b: VerilogFile, fast_slow_mode: bool) -> VerilogFile:
    ...
    if not sorted(m_a.normal_input_names) == sorted(m_b.normal_input_names):
        raise ValueError("expected m_a.normal_input_names == m_b.normal_input_names "+\
                         f"but got m_a.normal_input_names = {m_a.normal_input_names} "+\
                         f"got m_b.normal_input_names = {m_b.normal_input_names} "+\
                         f"diff = {set(m_a.normal_input_names) - set(m_b.normal_input_names)}")
